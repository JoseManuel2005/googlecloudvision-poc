      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <div className="text-center mb-14 space-y-5">
          ...
          <h1 className="text-5xl font-bold text-gray-900 dark:text-white leading-tight">
            Localización de{" "}
            <span className="block bg-yellow-500 bg-clip-text text-transparent">
              objetos en imágenes
            </span>
          </h1>
            ...
            <div ref={containerRef} className="relative mt-4 w-full h-80">
              ...
              {objects.map((obj, i) => {
                ...
                return (
                  ...
                  >
                    <span 
                      className={`absolute -top-6 left-0 bg-yellow-600 text-white text-xs font-semibold px-2 py-0.5 rounded-md shadow transition-opacity duration-200 ${
